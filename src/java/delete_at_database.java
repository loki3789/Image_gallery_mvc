 ...
 * @author lokesh
 */
public class delete_at_database extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (String s : selected_image_array) {
                out.println(s);
            }
            out.println("image is deleted</h1>");

            out.println("<a href=\"index.jsp\"><h1>Click here to go Main page</h1></a>");
        }
    }
